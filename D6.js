...
const stringMix = (string1, string2) => { 
 
 console.log (string1.slice (0,2) + string2.slice (-3))
}

stringMix ('cane', 'gatto')
...
const tenNumbers = () => {
  const arrTenElement = []
  for( let i = 0; i < 10; i++) {
    arrTenElement.push(Math.floor( Math.random() * 101))
  }
  console.log(arrTenElement)
  return arrTenElement
}
